...
public final class dsf implements Serializable {
    ...
    public dsf(Pattern pattern) {
        dqc.d(pattern, "nativePattern");
        this.b = pattern;
    }
    ...
    */
    public dsf(java.lang.String r2) {
        /*
            r1 = this;
            java.lang.String r0 = "pattern"
            defpackage.dqc.d(r2, r0)
            java.util.regex.Pattern r2 = java.util.regex.Pattern.compile(r2)
            java.lang.String r0 = "Pattern.compile(pattern)"
            defpackage.dqc.b(r2, r0)
            r1.<init>(r2)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dsf.<init>(java.lang.String):void");
    }
    ...
    public final String a(CharSequence charSequence, String str) {
        dqc.d(charSequence, "input");
        dqc.d(str, "replacement");
        String replaceAll = this.b.matcher(charSequence).replaceAll(str);
        dqc.b(replaceAll, "nativePattern.matcher(in…).replaceAll(replacement)");
        return replaceAll;
    }
    ...
    public final String toString() {
        ...
        dqc.b(pattern, "nativePattern.toString()");
        return pattern;
    }

    private final Object writeReplace() {
        String pattern = this.b.pattern();
        dqc.b(pattern, "nativePattern.pattern()");
    ...
    static final class b implements Serializable {
        ...
        private final Object readResolve() {
            ...
            dqc.b(compile, "Pattern.compile(pattern, flags)");
            return new dsf(compile);
        }
    }
