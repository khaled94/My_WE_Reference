...
public interface bfi {
    ...
    <K, V> void a(int i, bcy<K, V> bcyVar, Map<K, V> map) throws IOException;

    void a(int i, bgb bgbVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, bdy bdyVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, bdy bdyVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, bdy bdyVar) throws IOException;

    void b(int i, List<bgb> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, bdy bdyVar) throws IOException;
