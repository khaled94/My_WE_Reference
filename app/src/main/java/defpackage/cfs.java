...
public final class cfs implements bxm {
    private static final ThreadLocal<Cipher> a = new ThreadLocal<Cipher>() { // from class: cfs.1
    ...
    public cfs(byte[] bArr) throws GeneralSecurityException {
        cgs.a(bArr.length);
