...
public final class dsd {
    ...
    public static final dsd g = new dsd();
    ...
    static {
        ...
        dqc.b(forName2, "Charset.forName(\"UTF-16\")");
        b = forName2;
        Charset forName3 = Charset.forName("UTF-16BE");
        dqc.b(forName3, "Charset.forName(\"UTF-16BE\")");
        c = forName3;
        Charset forName4 = Charset.forName("UTF-16LE");
        dqc.b(forName4, "Charset.forName(\"UTF-16LE\")");
        d = forName4;
        Charset forName5 = Charset.forName("US-ASCII");
        dqc.b(forName5, "Charset.forName(\"US-ASCII\")");
        e = forName5;
        Charset forName6 = Charset.forName("ISO-8859-1");
        dqc.b(forName6, "Charset.forName(\"ISO-8859-1\")");
        f = forName6;
    }
