...
public final class dyp<E> {
    public static final a a = new a((byte) 0);
    public static final dyy b = new dyy("REMOVE_FROZEN");
    private static final /* synthetic */ AtomicReferenceFieldUpdater f = AtomicReferenceFieldUpdater.newUpdater(dyp.class, Object.class, "_next");
    private static final /* synthetic */ AtomicLongFieldUpdater g = AtomicLongFieldUpdater.newUpdater(dyp.class, "_state");
    ...
    private final dyp<E> a(int i, E e) {
    ...
    public final dyp<E> d() {
        return a(e());
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final dyp<E> b(long j) {
        dyp<E> dypVar = new dyp<>(this.c * 2, this.d);
        ...
        while (true) {
            ...
            if ((i & i3) != (i2 & i3)) {
                ...
                dypVar.h.set(dypVar.e & i, obj);
                i++;
            } else {
                dypVar._state = j & (-1152921504606846977L);
                return dypVar;
            }
        }
    }
    ...
    */
    public final int a(E r13) {
        ...
        L2c:
            ...
            if (r0 != 0) goto L4b
            java.util.concurrent.atomic.AtomicReferenceArray r0 = r12.h
            r11 = r9 & r10
        ...
        L4b:
            int r0 = r9 + 1
            r0 = r0 & r4
            java.util.concurrent.atomic.AtomicLongFieldUpdater r1 = defpackage.dyp.g
            long r4 = defpackage.dyp.a.b(r2, r0)
            r0 = r1
            r1 = r12
        ...
        L77:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dyp.a(java.lang.Object):int");
    }
    ...
    private final dyp<E> a(int i, int i2) {
        long j;
        int i3;
        do {
            j = this._state;
    ...
    private final dyp<E> a(long j) {
        while (true) {
            dyp<E> dypVar = (dyp) this._next;
            if (dypVar != null) {
                return dypVar;
            }
