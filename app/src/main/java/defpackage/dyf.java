...
public final class dyf<T> extends dum<T> implements dnu<T>, dof {
    public static final /* synthetic */ AtomicReferenceFieldUpdater f = AtomicReferenceFieldUpdater.newUpdater(dyf.class, Object.class, "_reusableCancellableContinuation");
    public final dtx a;
    public final dnu<T> b;
    public Object d = dyg.a();
    public final Object e = dzc.a(getContext());
    ...
    public dyf(dtx dtxVar, dnu<? super T> dnuVar) {
        super(-1);
        this.a = dtxVar;
        this.b = dnuVar;
    }
    ...
    public final void resumeWith(Object obj) {
        ...
        a2.a(true);
        try {
            dnw context2 = getContext();
            Object a3 = dzc.a(context2, this.e);
    ...
    public final String toString() {
        return "DispatchedContinuation[" + this.a + ", " + duh.a(this.b) + ']';
    }

    public final Throwable a(dtf<?> dtfVar) {
        do {
            ...
            if (obj != dyg.a) {
                ...
                throw new IllegalStateException(dqc.a("Inconsistent state ", obj).toString());
            }
        } while (!f.compareAndSet(this, dyg.a, dtfVar));
        return null;
    }
}
