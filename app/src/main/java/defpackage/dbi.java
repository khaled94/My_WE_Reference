...
public class dbi extends dab implements dbk, dcq, Serializable {
    @Inject
    djb a;
    ...
    private dbh d;
    private dbj e;
    private ArrayList<AvailableAddOnOfferingList> f;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (getArguments().getInt("position") == 1) {
            ...
            Iterator<AvailableAddOnOfferingList> it = this.f.iterator();
            while (it.hasNext()) {
    ...
    private void a(ArrayList<AvailableAddOnOfferingList> arrayList) {
        this.d = new dbh(getContext(), arrayList, this);
        this.b.setLayoutManager(new LinearLayoutManager(getContext()));
        this.b.setHasFixedSize(false);
        this.b.setAdapter(this.d);
        this.d.b = $$Lambda$dbi$I_9zvPgO5XtfuDUWKTMgVBqrU.INSTANCE;
    }
