...
public final class cse {
    ...
    public static String a(String str, csg csgVar) {
        if (str.length() != csgVar.b) {
            throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
        }
        StringBuilder sb = new StringBuilder(csgVar.b + csgVar.c);
        sb.append(str);
        int a2 = csgVar.a();
        if (a2 == 1) {
            sb.append(a(str, csgVar.c));
        } else {
            ...
            for (int i3 = 0; i3 < a2; i3++) {
                ...
                for (int i4 = i3; i4 < csgVar.b; i4 += a2) {
                ...
                while (i5 < iArr2[i3] * a2) {
                    sb.setCharAt(csgVar.b + i5, a3.charAt(i6));
                    i5 += a2;
                    i6++;
                }
            }
