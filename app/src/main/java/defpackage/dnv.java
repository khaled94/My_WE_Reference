...
public interface dnv extends dnw.b {
    public static final a a = a.a;

    <T> dnu<T> interceptContinuation(dnu<? super T> dnuVar);

    void releaseInterceptedContinuation(dnu<?> dnuVar);
    ...
    /* renamed from: dnv$a */
    /* loaded from: classes2.dex */
    public static final class a implements dnw.c<dnv> {
