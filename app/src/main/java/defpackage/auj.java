...
public final class auj {
    ...
    */
    public static void a(defpackage.aui r18, java.lang.StringBuilder r19, int r20) {
        /*
            Method dump skipped, instructions count: 677
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.auj.a(aui, java.lang.StringBuilder, int):void");
    }
    ...
    public static final void a(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(avm.a(art.a((String) obj)));
                sb.append('\"');
            } else if (obj instanceof art) {
                sb.append(": \"");
                sb.append(avm.a((art) obj));
                sb.append('\"');
