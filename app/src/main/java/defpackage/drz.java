...
public final class drz<T, R> implements drq<R> {
    final drq<T> a;
    final dow<T, R> b;
    ...
    /* renamed from: drz$a */
    /* loaded from: classes2.dex */
    public static final class a implements dqk, Iterator<R> {
        ...
        a() {
            this.b = drz.this.a.iterator();
        }

        @Override // java.util.Iterator
        public final R next() {
            return drz.this.b.invoke(this.b.next());
        }
    ...
    public drz(drq<? extends T> drqVar, dow<? super T, ? extends R> dowVar) {
        dqc.d(drqVar, "sequence");
        dqc.d(dowVar, "transformer");
        this.a = drqVar;
        this.b = dowVar;
    }
