...
public interface awm {
    ...
    void a(int i, art artVar) throws IOException;

    <K, V> void a(int i, aty<K, V> atyVar, Map<K, V> map) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, aux auxVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, aux auxVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, aux auxVar) throws IOException;

    void b(int i, List<art> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, aux auxVar) throws IOException;
