...
public final class dzd<T> implements dwb<T> {
    private final T a;
    private final ThreadLocal<T> b;
    private final dnw.c<?> c;

    public dzd(T t, ThreadLocal<T> threadLocal) {
        this.a = t;
        this.b = threadLocal;
        this.c = new dze(threadLocal);
    }
