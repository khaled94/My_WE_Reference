...
public final class dyr {
    ...
    public static final dvr a(MainDispatcherFactory mainDispatcherFactory, List<? extends MainDispatcherFactory> list) {
        try {
    ...
    public static /* synthetic */ dys a(Throwable th, int i) {
        if ((i & 1) != 0) {
            th = null;
        }
    ...
    private static final dys a(Throwable th, String str) {
        if (a) {
            return new dys(th, str);
        }
        if (th != null) {
            throw th;
        }
