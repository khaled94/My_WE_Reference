...
final class awc extends avy {
        ...
        while (i < i3) {
            ...
            if (!(b2 >= 0)) {
                if (awa.a(b2)) {
                    ...
                    int i7 = i6 + 1;
                    awa.a(b2, bArr[i6], bArr[i7], cArr, i5);
                    i = i7 + 1;
                    i5++;
                } else if (i6 >= i3 - 2) {
                    throw zzfi.i();
                    ...
                    byte b3 = bArr[i6];
                    int i9 = i8 + 1;
                    awa.a(b2, b3, bArr[i8], bArr[i9], cArr, i5);
                    i = i9 + 1;
                    i5 = i5 + 1 + 1;
                }
            } else {
    ...
    */
    public final int a(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.awc.a(java.lang.CharSequence, byte[], int, int):int");
    }
