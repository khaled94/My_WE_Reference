...
public class dsp extends dso {
    ...
    public static final String a(String str, String str2, String str3) {
        dqc.d(str, "$this$replace");
        dqc.d(str2, "oldValue");
        dqc.d(str3, "newValue");
        String str4 = str;
        int i = 0;
        int a = dsg.a(str4, str2, 0);
        if (a < 0) {
            return str;
        }
        int length = str2.length();
        int b = drb.b(length, 1);
        ...
        do {
            ...
            a = dsg.a(str4, str2, a + b);
        } while (a > 0);
        sb.append((CharSequence) str4, i, str.length());
        String sb2 = sb.toString();
        dqc.b(sb2, "stringBuilder.append(this, i, length).toString()");
        return sb2;
    }

    public static final boolean c(String str, String str2) {
        dqc.d(str, "$this$startsWith");
        dqc.d(str2, "prefix");
        return str.startsWith(str2);
    }

    public static final boolean d(String str, String str2) {
        dqc.d(str, "$this$endsWith");
        dqc.d(str2, "suffix");
    ...
    public static final boolean a(CharSequence charSequence) {
        boolean z;
        dqc.d(charSequence, "$this$isBlank");
        if (charSequence.length() != 0) {
            Iterator<Integer> it = dsg.c(charSequence).iterator();
            while (true) {
                if (!it.hasNext()) {
                    z = true;
                    break;
                } else if (!dsa.a(charSequence.charAt(((dnf) it).nextInt()))) {
                    z = false;
                    break;
                }
            }
