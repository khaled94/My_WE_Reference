...
public abstract class dqs {
    ...
    public static final dqs a = don.a.a();
    ...
    public int a(int i, int i2) {
        ...
        if (!(i2 > i)) {
            ...
            dqc.d(valueOf, TypedValues.Transition.S_FROM);
            dqc.d(valueOf2, "until");
    ...
    /* renamed from: dqs$a */
    /* loaded from: classes2.dex */
    public static final class a extends dqs implements Serializable {
        private a() {
        }
        ...
        /* loaded from: classes2.dex */
        static final class C0028a implements Serializable {
