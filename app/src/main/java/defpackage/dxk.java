...
public class dxk<T> extends dxs<T> {
    private final dph<dxa<? super T>, dnu<? super dmg>, Object> d;

    /* JADX WARN: Multi-variable type inference failed */
    public dxk(dph<? super dxa<? super T>, ? super dnu<? super dmg>, ? extends Object> dphVar, dnw dnwVar, dwo dwoVar) {
        super(dnwVar, dwoVar);
        this.d = dphVar;
    }
    ...
    @Override // defpackage.dxs
    public Object a(dxa<? super T> dxaVar, dnu<? super dmg> dnuVar) {
        Object invoke = this.d.invoke(dxaVar, dnuVar);
        return invoke != dny.COROUTINE_SUSPENDED ? dmg.a : invoke;
    }
}
