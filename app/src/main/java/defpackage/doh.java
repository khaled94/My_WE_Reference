...
public final class doh {
    ...
    public static final int a(doc docVar) {
        try {
            Field declaredField = docVar.getClass().getDeclaredField("label");
            dqc.b(declaredField, "field");
            declaredField.setAccessible(true);
            Object obj = declaredField.get(docVar);
