...
public abstract class drs<T> {
    public abstract Object a(T t, dnu<? super dmg> dnuVar);

    public abstract Object a(Iterator<? extends T> it, dnu<? super dmg> dnuVar);

    public final Object a(drq<? extends T> drqVar, dnu<? super dmg> dnuVar) {
        Object a = a((Iterator) drqVar.iterator(), dnuVar);
