...
public final class dzj {
    public static final <T, R> Object a(dyw<? super T> dywVar, R r, dph<? super R, ? super dnu<? super T>, ? extends Object> dphVar) {
        Object obj;
        try {
        } catch (Throwable th) {
            obj = new dtr(th);
        ...
        if (dphVar != null) {
            obj = ((dph) dqj.a(dphVar, 2)).invoke(r, dywVar);
            if (obj != dny.COROUTINE_SUSPENDED) {
                Object d = dywVar.d(obj);
                if (d != dvp.a) {
                    if (d instanceof dtr) {
                        Throwable th2 = ((dtr) d).a;
                        dnu<? super T> dnuVar = dywVar.e;
                        if (dug.c() && (dnuVar instanceof dof)) {
                            throw dyx.a(th2, (dof) dnuVar);
                        }
                        throw th2;
                    }
                    return dvp.b(d);
