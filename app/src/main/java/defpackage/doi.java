...
final class doi {
    static a b;
    public static final doi c = new doi();
    static final a a = new a(null, null, null);
    ...
    public static a a(doc docVar) {
        try {
            a aVar = new a(Class.class.getDeclaredMethod("getModule", new Class[0]), docVar.getClass().getClassLoader().loadClass("java.lang.Module").getDeclaredMethod("getDescriptor", new Class[0]), docVar.getClass().getClassLoader().loadClass("java.lang.module.ModuleDescriptor").getDeclaredMethod("name", new Class[0]));
            b = aVar;
            return aVar;
