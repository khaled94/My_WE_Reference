...
public final class dwl {
    public static final dyy a = new dyy("EMPTY");
    public static final dyy b = new dyy("OFFER_SUCCESS");
    public static final dyy c = new dyy("OFFER_FAILED");
    public static final dyy d = new dyy("POLL_FAILED");
    public static final dyy e = new dyy("ENQUEUE_FAILED");
    public static final dyy f = new dyy("ON_CLOSE_HANDLER_INVOKED");
}
