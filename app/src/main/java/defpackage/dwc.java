...
public final class dwc {
    public static final dwc a = new dwc();
    private static final ThreadLocal<dut> b = new ThreadLocal<>();
    ...
    public static dut a() {
        dut dutVar = b.get();
        if (dutVar == null) {
            dsz dszVar = new dsz(Thread.currentThread());
            b.set(dszVar);
            return dszVar;
        }
        return dutVar;
    ...
    public static void a(dut dutVar) {
        b.set(dutVar);
    }
}
