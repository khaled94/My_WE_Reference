...
public interface dtf<T> extends dnu<T> {
    Object a(T t);

    Object a(T t, dow<? super Throwable, dmg> dowVar);

    Object a(Throwable th);

    void a(dow<? super Throwable, dmg> dowVar);

    void a(dtx dtxVar, T t);

    void b(Object obj);

    void b(T t, dow<? super Throwable, dmg> dowVar);
