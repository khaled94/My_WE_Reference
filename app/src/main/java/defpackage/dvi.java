...
public interface dvi extends dnw.b {
    public static final b b = b.a;

    dtl a(dtn dtnVar);

    duq a(boolean z, boolean z2, dow<? super Throwable, dmg> dowVar);

    Object a(dnu<? super dmg> dnuVar);

    void a(CancellationException cancellationException);

    boolean a();

    duq a_(dow<? super Throwable, dmg> dowVar);
    ...
    /* renamed from: dvi$b */
    /* loaded from: classes2.dex */
    public static final class b implements dnw.c<dvi> {
    ...
    public static final class a {
        public static /* synthetic */ duq a(dvi dviVar, boolean z, boolean z2, dow dowVar, int i) {
            if ((i & 1) != 0) {
                z = false;
            }
            if ((i & 2) != 0) {
