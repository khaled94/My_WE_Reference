...
public class dtr {
    private static final /* synthetic */ AtomicIntegerFieldUpdater b = AtomicIntegerFieldUpdater.newUpdater(dtr.class, "_handled");
    volatile /* synthetic */ int _handled;
    public final Throwable a;

    public /* synthetic */ dtr(Throwable th) {
        this(th, false);
    }

    public dtr(Throwable th, boolean z) {
        this.a = th;
        this._handled = z ? 1 : 0;
    }
