...
public final class TypedArrayKt {
    ...
    public static final CharSequence[] getTextArrayOrThrow(TypedArray typedArray, int i) {
        ...
        dqc.b(textArray, "getTextArray(index)");
        return textArray;
    }

    public static final <R> R use(TypedArray typedArray, dow<? super TypedArray, ? extends R> dowVar) {
        dqc.d(typedArray, "<this>");
        dqc.d(dowVar, "block");
        R invoke = dowVar.invoke(typedArray);
        typedArray.recycle();
        return invoke;
    }
}
