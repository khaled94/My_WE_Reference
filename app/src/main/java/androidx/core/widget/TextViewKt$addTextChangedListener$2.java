...
public final class TextViewKt$addTextChangedListener$2 extends dqd implements dpm<CharSequence, Integer, Integer, Integer, dmg> {
    ...
    public final /* synthetic */ dmg invoke(CharSequence charSequence, Integer num, Integer num2, Integer num3) {
