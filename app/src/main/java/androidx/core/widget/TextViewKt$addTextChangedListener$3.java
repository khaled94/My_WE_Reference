...
public final class TextViewKt$addTextChangedListener$3 extends dqd implements dow<Editable, dmg> {
    ...
    public final /* bridge */ /* synthetic */ dmg invoke(Editable editable) {
        invoke2(editable);
        return dmg.a;
    }
}
