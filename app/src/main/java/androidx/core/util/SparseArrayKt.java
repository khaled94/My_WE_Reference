...
public final class SparseArrayKt {
    ...
    public static final <T> T getOrElse(SparseArray<T> sparseArray, int i, dov<? extends T> dovVar) {
        dqc.d(sparseArray, "<this>");
    ...
    public static final <T> boolean remove(SparseArray<T> sparseArray, int i, T t) {
        ...
        if (indexOfKey < 0 || !dqc.a(t, sparseArray.valueAt(indexOfKey))) {
            return false;
        }
    ...
    public static final <T> void forEach(SparseArray<T> sparseArray, dph<? super Integer, ? super T, dmg> dphVar) {
        dqc.d(sparseArray, "<this>");
        dqc.d(dphVar, "action");
        ...
        if (size > 0) {
            ...
            while (true) {
                int i2 = i + 1;
                dphVar.invoke(Integer.valueOf(sparseArray.keyAt(i)), sparseArray.valueAt(i));
                if (i2 >= size) {
                    return;
                }
                i = i2;
    ...
    public static final <T> dnf keyIterator(final SparseArray<T> sparseArray) {
        dqc.d(sparseArray, "<this>");
        return new dnf() { // from class: androidx.core.util.SparseArrayKt$keyIterator$1
            private int index;
