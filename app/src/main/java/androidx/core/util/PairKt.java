...
public final class PairKt {
    ...
    public static final <F, S> dma<F, S> toKotlinPair(Pair<F, S> pair) {
        dqc.d(pair, "<this>");
        return new dma<>(pair.first, pair.second);
    }

    public static final <F, S> Pair<F, S> toAndroidXPair(dma<? extends F, ? extends S> dmaVar) {
        dqc.d(dmaVar, "<this>");
        return new Pair<>(dmaVar.a, dmaVar.b);
    }
    ...
    public static final <F, S> Pair<F, S> toAndroidPair(dma<? extends F, ? extends S> dmaVar) {
        dqc.d(dmaVar, "<this>");
        return new Pair<>(dmaVar.a, dmaVar.b);
    }
}
