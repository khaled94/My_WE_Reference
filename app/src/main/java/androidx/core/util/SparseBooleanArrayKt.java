...
public final class SparseBooleanArrayKt {
    ...
    public static final SparseBooleanArray plus(SparseBooleanArray sparseBooleanArray, SparseBooleanArray sparseBooleanArray2) {
        dqc.d(sparseBooleanArray, "<this>");
        dqc.d(sparseBooleanArray2, "other");
    ...
    public static final boolean getOrElse(SparseBooleanArray sparseBooleanArray, int i, dov<Boolean> dovVar) {
        dqc.d(sparseBooleanArray, "<this>");
        dqc.d(dovVar, "defaultValue");
        int indexOfKey = sparseBooleanArray.indexOfKey(i);
        return indexOfKey >= 0 ? sparseBooleanArray.valueAt(indexOfKey) : dovVar.invoke().booleanValue();
    }
    ...
    public static final void forEach(SparseBooleanArray sparseBooleanArray, dph<? super Integer, ? super Boolean, dmg> dphVar) {
        dqc.d(sparseBooleanArray, "<this>");
        dqc.d(dphVar, "action");
        ...
        if (size > 0) {
            ...
            while (true) {
                int i2 = i + 1;
                dphVar.invoke(Integer.valueOf(sparseBooleanArray.keyAt(i)), Boolean.valueOf(sparseBooleanArray.valueAt(i)));
                if (i2 >= size) {
                    return;
                }
                i = i2;
    ...
    public static final dnf keyIterator(final SparseBooleanArray sparseBooleanArray) {
        dqc.d(sparseBooleanArray, "<this>");
        return new dnf() { // from class: androidx.core.util.SparseBooleanArrayKt$keyIterator$1
            private int index;
    ...
    public static final dmo valueIterator(final SparseBooleanArray sparseBooleanArray) {
        dqc.d(sparseBooleanArray, "<this>");
        return new dmo() { // from class: androidx.core.util.SparseBooleanArrayKt$valueIterator$1
            private int index;
