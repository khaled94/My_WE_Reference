...
public final class BitmapKt {
    public static final Bitmap applyCanvas(Bitmap bitmap, dow<? super Canvas, dmg> dowVar) {
        dqc.d(bitmap, "<this>");
        dqc.d(dowVar, "block");
        dowVar.invoke(new Canvas(bitmap));
        return bitmap;
    }
    ...
    public static /* synthetic */ Bitmap scale$default(Bitmap bitmap, int i, int i2, boolean z, int i3, Object obj) {
        ...
        dqc.b(createScaledBitmap, "createScaledBitmap(this, width, height, filter)");
    ...
    public static /* synthetic */ Bitmap createBitmap$default(int i, int i2, Bitmap.Config config, boolean z, ColorSpace colorSpace, int i3, Object obj) {
        ...
        if ((i3 & 16) != 0) {
            ...
            dqc.b(colorSpace, "get(ColorSpace.Named.SRGB)");
        }
        dqc.d(config, "config");
        dqc.d(colorSpace, "colorSpace");
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, config, z, colorSpace);
        dqc.b(createBitmap, "createBitmap(width, height, config, hasAlpha, colorSpace)");
        return createBitmap;
    }
