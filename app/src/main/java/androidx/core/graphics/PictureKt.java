...
public final class PictureKt {
    public static final Picture record(Picture picture, int i, int i2, dow<? super Canvas, dmg> dowVar) {
        dqc.d(picture, "<this>");
        dqc.d(dowVar, "block");
        Canvas beginRecording = picture.beginRecording(i, i2);
        dqc.b(beginRecording, "beginRecording(width, height)");
        try {
            dowVar.invoke(beginRecording);
            return picture;
        } finally {
