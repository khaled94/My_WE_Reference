        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    i10 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i14, Integer.MIN_VALUE);
                } else if (layoutParams.width == -1) {
                    i10 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i14, BasicMeasure.EXACTLY);
                } else {
                    i10 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, BasicMeasure.EXACTLY);
                }
                if (layoutParams.height == -2) {
                    i11 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i11 = View.MeasureSpec.makeMeasureSpec(i3, BasicMeasure.EXACTLY);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, BasicMeasure.EXACTLY);
                }
                ...
                if (childAt2.getVisibility() != i5) {
                    ...
                    if (childAt2.getVisibility() != i5) {
                        ...
                        if (z2 && childAt2 != this.mSlideableView) {
                            if (layoutParams2.width < 0 && (measuredWidth2 > i15 || layoutParams2.weight > 0.0f)) {
                                if (z4) {
                                    if (layoutParams2.height == -2) {
                                        ...
                                        i8 = BasicMeasure.EXACTLY;
                                        i9 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, BasicMeasure.EXACTLY);
                                    }
                                } else {
                                    i8 = BasicMeasure.EXACTLY;
                                    i9 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), BasicMeasure.EXACTLY);
                                }
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(i15, i8), i9);
                            }
                            ...
                            if (layoutParams2.width == 0) {
                                if (layoutParams2.height == -2) {
                                    ...
                                    i7 = View.MeasureSpec.makeMeasureSpec(i3, BasicMeasure.EXACTLY);
                                } else {
                                    i7 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, BasicMeasure.EXACTLY);
                                }
                            } else {
                            ...
                            if (z2) {
                                ...
                                i6 = i15;
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i12)) / f)), BasicMeasure.EXACTLY), i7);
                                i16++;
                                i15 = i6;
                                i5 = 8;
                            }
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    i5 = (!this.mCanSlide || (i8 = this.mParallaxBy) == 0) ? 0 : (int) ((1.0f - this.mSlideOffset) * i8);
                    i10 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i6 = (i9 - i10) + i5;
