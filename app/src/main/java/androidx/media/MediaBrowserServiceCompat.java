...
public abstract class MediaBrowserServiceCompat extends Service {
                    ...
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (hVar != null) {
                            for (Bundle bundle : MediaBrowserServiceImplApi21.this.mRootExtrasList) {
                                BundleCompat.putBinder(bundle, MediaBrowserProtocol.EXTRA_SESSION_BINDER, hVar.asBinder());
                            }
                        }
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                if (MediaBrowserServiceCompat.this.mSession == null) {
                    ...
                    h hVar = MediaBrowserServiceCompat.this.mSession.b;
                    BundleCompat.putBinder(bundle2, MediaBrowserProtocol.EXTRA_SESSION_BINDER, hVar == null ? null : hVar.asBinder());
                }
            }
        ...
        public final void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (l) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (l) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (l) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    class ServiceBinderImpl {
        ...
        public void getMediaItem(final String str, final l lVar, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.5
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        ...
                        MediaBrowserServiceCompat.this.performLoadItem(str, connectionRecord, lVar);
                    }
                }
            });
        }
        ...
        public void search(final String str, final Bundle bundle, final l lVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || lVar == null) {
                return;
            }
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.8
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        ...
                        MediaBrowserServiceCompat.this.performSearch(str, bundle, connectionRecord, lVar);
                    }
                }
            });
        }

        public void sendCustomAction(final String str, final Bundle bundle, final l lVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || lVar == null) {
                return;
            }
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                ...
                public void run() {
                    ...
                    MediaBrowserServiceCompat.this.performCustomAction(str, bundle, connectionRecord, lVar);
                }
            });
        }
    }
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final l lVar) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final l lVar) {
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final l lVar) {
