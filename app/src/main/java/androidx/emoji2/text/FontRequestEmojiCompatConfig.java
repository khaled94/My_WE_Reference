    ...
    public static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                ...
                this.mExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.-$$Lambda$ES6bNQ2WxakT4jb5Yd_xfZnnCos
        ...
        private void scheduleRetry(Uri uri, long j) {
            synchronized (this.mLock) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.-$$Lambda$o9en1eDu3tuAGqXsk18wcpLrjnI
                        @Override // java.lang.Runnable
                        public final void run() {
