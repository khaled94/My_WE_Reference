...
public class ExifInterface {
            ...
            if ((i4 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i4].get(str3)) != null) {
                if (str4 == null) {
                    ...
                    if (exifTag.primaryFormat == ((Integer) guessDataFormat.first).intValue() || exifTag.primaryFormat == ((Integer) guessDataFormat.second).intValue()) {
                        ...
                        String str5 = "";
                        sb3.append(exifTag.secondaryFormat == -1 ? str5 : ", " + IFD_FORMAT_NAMES[exifTag.secondaryFormat]);
                        sb3.append(" (guess: ");
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(7:(6:(2:16|(1:18)(2:19|20))(2:21|(1:36)(17:25|106|26|102|27|38|104|39|(1:41)(2:42|(1:47)(1:46))|48|99|49|101|50|(1:52)(2:53|(1:55)(2:56|(1:58)))|59|60))|101|50|(0)(0)|59|60)|104|39|(0)(0)|48|99|49) */
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00b5 A[Catch: all -> 0x0113, Exception -> 0x0116, TryCatch #10 {Exception -> 0x0116, all -> 0x0113, blocks: (B:39:0x00ac, B:41:0x00b5, B:42:0x00bd, B:44:0x00c1, B:46:0x00c5, B:48:0x00d5), top: B:104:0x00ac }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x00bd A[Catch: all -> 0x0113, Exception -> 0x0116, TryCatch #10 {Exception -> 0x0116, all -> 0x0113, blocks: (B:39:0x00ac, B:41:0x00b5, B:42:0x00bd, B:44:0x00c1, B:46:0x00c5, B:48:0x00d5), top: B:104:0x00ac }] */
    /* JADX WARN: Removed duplicated region for block: B:52:0x00e4 A[Catch: all -> 0x0107, Exception -> 0x0109, TryCatch #12 {Exception -> 0x0109, all -> 0x0107, blocks: (B:50:0x00df, B:52:0x00e4, B:53:0x00e8, B:55:0x00ee, B:56:0x00f2, B:58:0x00f8), top: B:101:0x00df }] */
    /* JADX WARN: Removed duplicated region for block: B:53:0x00e8 A[Catch: all -> 0x0107, Exception -> 0x0109, TryCatch #12 {Exception -> 0x0109, all -> 0x0107, blocks: (B:50:0x00df, B:52:0x00e4, B:53:0x00e8, B:55:0x00ee, B:56:0x00f2, B:58:0x00f8), top: B:101:0x00df }] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:36:0x0061 A[Catch: all -> 0x0094, Exception -> 0x0099, TRY_ENTER, TRY_LEAVE, TryCatch #6 {Exception -> 0x0099, all -> 0x0094, blocks: (B:36:0x0061, B:39:0x0071, B:41:0x007d, B:46:0x0088, B:47:0x008d, B:48:0x008e, B:49:0x0093, B:54:0x009b, B:55:0x00a0), top: B:70:0x005f }] */
    /* JADX WARN: Removed duplicated region for block: B:54:0x009b A[Catch: all -> 0x0094, Exception -> 0x0099, TryCatch #6 {Exception -> 0x0099, all -> 0x0094, blocks: (B:36:0x0061, B:39:0x0071, B:41:0x007d, B:46:0x0088, B:47:0x008d, B:48:0x008e, B:49:0x0093, B:54:0x009b, B:55:0x00a0), top: B:70:0x005f }] */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:67:0x017f, code lost:
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:33:0x00a2 A[FALL_THROUGH] */
    ...
    */
    ...
    private void getHeifAttributes(final ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        try {
            ...
            if (DEBUG) {
                StringBuilder sb = new StringBuilder("Heif meta: ");
                sb.append(str3);
                sb.append("x");
                sb.append(str2);
                sb.append(", rotation ");
    ...
    private void saveJpegAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        if (DEBUG) {
            StringBuilder sb = new StringBuilder("saveJpegAttributes starting with (inputStream: ");
    ...
    private void savePngAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        Throwable th;
        if (DEBUG) {
            StringBuilder sb = new StringBuilder("savePngAttributes starting with (inputStream: ");
            sb.append(inputStream);
            sb.append(", outputStream: ");
            sb.append(outputStream);
            sb.append(")");
    ...
    private void saveWebpAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        if (DEBUG) {
            StringBuilder sb = new StringBuilder("saveWebpAttributes starting with (inputStream: ");
            sb.append(inputStream);
            sb.append(", outputStream: ");
            sb.append(outputStream);
            sb.append(")");
