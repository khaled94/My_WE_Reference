...
public final class LifecycleController {
    ...
    public LifecycleController(Lifecycle lifecycle, Lifecycle.State state, DispatchQueue dispatchQueue, final dvi dviVar) {
        dqc.d(lifecycle, "lifecycle");
        dqc.d(state, "minState");
        dqc.d(dispatchQueue, "dispatchQueue");
        dqc.d(dviVar, "parentJob");
        ...
        this.observer = new LifecycleEventObserver() { // from class: androidx.lifecycle.LifecycleController$observer$1
            ...
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                ...
                dqc.d(event, "<anonymous parameter 1>");
                Lifecycle lifecycle2 = lifecycleOwner.getLifecycle();
                dqc.b(lifecycle2, "source.lifecycle");
                ...
                dqc.b(lifecycle3, "source.lifecycle");
    ...
    public final void handleDestroy(dvi dviVar) {
        dviVar.a((CancellationException) null);
        finish();
    }
}
