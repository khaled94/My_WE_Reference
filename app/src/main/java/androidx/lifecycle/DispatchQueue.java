...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(final dnw dnwVar, final Runnable runnable) {
        dqc.d(dnwVar, "context");
        dqc.d(runnable, "runnable");
        dvr a = dup.b().a();
        if (a.isDispatchNeeded(dnwVar) || canRun()) {
            a.dispatch(dnwVar, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$dispatchAndEnqueue$$inlined$with$lambda$1
