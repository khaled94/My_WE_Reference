...
public class KeyParser {
    ...
    private static TypedBundle parse(String str, Ids ids, DataType dataType) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (i2 == -1) {
                    System.err.println("unknown type ".concat(String.valueOf(content)));
                } else {
                    ...
                    if (i3 == 1) {
                        ...
                        printStream.println("parse " + content + " INT_MASK > " + value.getInt());
                    } else if (i3 == 4) {
                        typedBundle.add(i2, value.getFloat());
                        PrintStream printStream2 = System.out;
                        printStream2.println("parse " + content + " FLOAT_MASK > " + value.getFloat());
                    } else if (i3 == 8) {
                        typedBundle.add(i2, value.content());
                        PrintStream printStream3 = System.out;
                        printStream3.println("parse " + content + " STRING_MASK > " + value.content());
                    }
                }
            }
    ...
    public static TypedBundle parseAttributes(String str) {
        return parse(str, $$Lambda$ZF7862vVBXPmORJWWXJju9vX5I.INSTANCE, $$Lambda$FUNwnTNlXFO113ASo5uSgbCvIeQ.INSTANCE);
    }
