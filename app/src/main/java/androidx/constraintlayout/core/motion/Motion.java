...
public class Motion {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (keyCycleOscillator2 != null) {
                fArr[i3] = fArr[i3] + keyCycleOscillator2.get(f6);
            } else if (splineSet != null) {
                fArr[i3] = fArr[i3] + splineSet.get(f6);
            }
            if (keyCycleOscillator3 != null) {
                int i5 = i3 + 1;
                fArr[i5] = fArr[i5] + keyCycleOscillator3.get(f6);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        for (String str5 : this.mEndMotionPath.customAttributes.keySet()) {
            if (this.mStartMotionPath.customAttributes.containsKey(str5) && !hashSet2.contains("CUSTOM,".concat(String.valueOf(str5)))) {
                hashSet4.add(str5);
            }
        }
