...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
            ...
            while (it.hasNext()) {
                ...
                if (constraintWidget2.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                    ...
                    if (!constraintWidget2.isInHorizontalChain() && !constraintWidget2.isInVirtualLayout()) {
                        if ((((next != constraintWidget2.mLeft || constraintWidget2.mRight.mTarget == null || !constraintWidget2.mRight.mTarget.hasFinalValue()) && (next != constraintWidget2.mRight || constraintWidget2.mLeft.mTarget == null || !constraintWidget2.mLeft.mTarget.hasFinalValue())) ? false : EARLY_TERMINATION) && !constraintWidget2.isInHorizontalChain()) {
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z2 = ((next2 != constraintWidget3.mLeft || constraintWidget3.mRight.mTarget == null || !constraintWidget3.mRight.mTarget.hasFinalValue()) && (next2 != constraintWidget3.mRight || constraintWidget3.mLeft.mTarget == null || !constraintWidget3.mLeft.mTarget.hasFinalValue())) ? false : EARLY_TERMINATION;
    ...
    private static void verticalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
            ...
            while (it.hasNext()) {
                ...
                if (constraintWidget2.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                    ...
                    if (!constraintWidget2.isInVerticalChain() && !constraintWidget2.isInVirtualLayout()) {
                        if ((((next != constraintWidget2.mTop || constraintWidget2.mBottom.mTarget == null || !constraintWidget2.mBottom.mTarget.hasFinalValue()) && (next != constraintWidget2.mBottom || constraintWidget2.mTop.mTarget == null || !constraintWidget2.mTop.mTarget.hasFinalValue())) ? false : EARLY_TERMINATION) && !constraintWidget2.isInVerticalChain()) {
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z = ((next2 != constraintWidget3.mTop || constraintWidget3.mBottom.mTarget == null || !constraintWidget3.mBottom.mTarget.hasFinalValue()) && (next2 != constraintWidget3.mBottom || constraintWidget3.mTop.mTarget == null || !constraintWidget3.mTop.mTarget.hasFinalValue())) ? false : EARLY_TERMINATION;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:99:0x01ea, code lost:
        if (r4.mListAnchors[r23].mTarget.mOwner == r0) goto L101;
     */
