        ...
        if (i != -1 || i2 != -1) {
            ...
            if (i != -1 && i2 != -1) {
                ...
                if (this.mParams.bottomToBottom != -1) {
                    constraintProperties.connect(4, this.mParams.bottomToBottom, 4, 0);
                } else if (this.mParams.topToTop != -1) {
                    constraintProperties2.connect(3, this.mParams.topToTop, 3, 0);
                }
            }
        }
        removeConstraints(3);
        ...
        if (i != -1 || i2 != -1) {
            ...
            if (i != -1 && i2 != -1) {
                ...
                if (this.mParams.rightToRight != -1) {
                    constraintProperties.connect(2, this.mParams.rightToRight, 2, 0);
                } else if (this.mParams.leftToLeft != -1) {
                    constraintProperties2.connect(1, this.mParams.leftToLeft, 1, 0);
                }
            }
            removeConstraints(1);
            removeConstraints(2);
        } else {
            int i3 = this.mParams.startToEnd;
            ...
            if (i3 != -1 || i4 != -1) {
                ...
                ConstraintProperties constraintProperties4 = new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i4));
                if (i3 != -1 && i4 != -1) {
                    constraintProperties3.connect(7, i4, 6, 0);
                    constraintProperties4.connect(6, i, 7, 0);
                } else if (i != -1 || i4 != -1) {
                    if (this.mParams.rightToRight != -1) {
                        constraintProperties3.connect(7, this.mParams.rightToRight, 7, 0);
                    } else if (this.mParams.leftToLeft != -1) {
                        constraintProperties4.connect(6, this.mParams.leftToLeft, 6, 0);
                    }
                }
            }
            removeConstraints(6);
