    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (viewOscillator2 != null) {
                fArr[i3] = fArr[i3] + viewOscillator2.get(f6);
            } else if (viewSpline != null) {
                fArr[i3] = fArr[i3] + viewSpline.get(f6);
            }
            if (viewOscillator3 != null) {
                int i5 = i3 + 1;
                fArr[i5] = fArr[i5] + viewOscillator3.get(f6);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            if (iArr2[i13] < MotionPaths.names.length) {
                String concat = String.valueOf(MotionPaths.names[this.mInterpolateVariables[i13]]).concat(" [");
            ...
            while (i16 < size) {
                if (motionPathsArr[i16].hasCustomData(str7)) {
                    if (dArr4 == null) {
                        ...
                        iArr3[1] = motionPathsArr[i16].getCustomDataCount(str7);
                        iArr3[c] = size;
                        dArr4 = (double[][]) Array.newInstance(double.class, iArr3);
                    }
                    dArr3[i17] = motionPathsArr[i16].time;
                    motionPathsArr[i16].getCustomData(str7, dArr4[i17], 0);
                    i17++;
                }
                i16++;
                i3 = 2;
