...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<dmg> {
    private final ActivityResultContract<I, O> callerContract;
    private final I input;
    private final ActivityResultLauncher<I> launcher;
    private final dlv resultContract$delegate = dlw.a(new ActivityResultCallerLauncher$resultContract$2(this));
    ...
    public ActivityResultCallerLauncher(ActivityResultLauncher<I> activityResultLauncher, ActivityResultContract<I, O> activityResultContract, I i) {
        dqc.d(activityResultLauncher, "launcher");
        dqc.d(activityResultContract, "callerContract");
        this.launcher = activityResultLauncher;
        this.callerContract = activityResultContract;
        this.input = i;
    }

    public final ActivityResultContract<dmg, O> getResultContract() {
        return (ActivityResultContract) this.resultContract$delegate.getValue();
    }

    public final void launch(dmg dmgVar, ActivityOptionsCompat activityOptionsCompat) {
    ...
    @Override // androidx.activity.result.ActivityResultLauncher
    public final ActivityResultContract<dmg, ?> getContract() {
        return (ActivityResultContract<dmg, O>) getResultContract();
    }
}
