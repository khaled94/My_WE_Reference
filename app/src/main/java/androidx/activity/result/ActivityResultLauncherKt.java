...
public final class ActivityResultLauncherKt {
    ...
    public static final void launch(ActivityResultLauncher<Void> activityResultLauncher, ActivityOptionsCompat activityOptionsCompat) {
        dqc.d(activityResultLauncher, "<this>");
    ...
    public static final void launchUnit(ActivityResultLauncher<dmg> activityResultLauncher, ActivityOptionsCompat activityOptionsCompat) {
        dqc.d(activityResultLauncher, "<this>");
        activityResultLauncher.launch(dmg.a, activityOptionsCompat);
    }
}
