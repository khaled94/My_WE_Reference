...
public final class LruCacheKt$lruCache$4 extends LruCache<K, V> {
    final /* synthetic */ dow $create;
    final /* synthetic */ int $maxSize;
    final /* synthetic */ dpm $onEntryRemoved;
    final /* synthetic */ dph $sizeOf;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LruCacheKt$lruCache$4(dph dphVar, dow dowVar, dpm dpmVar, int i, int i2) {
        super(i2);
        this.$sizeOf = dphVar;
        this.$create = dowVar;
