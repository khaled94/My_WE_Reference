...
public class FragmentStateManager {
    ...
    public FragmentStateManager(FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher, FragmentStore fragmentStore, ClassLoader classLoader, FragmentFactory fragmentFactory, FragmentState fragmentState) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            new StringBuilder("Instantiated fragment ").append(this.mFragment);
        }
    }
                        ...
                        switch (this.mFragment.mState - 1) {
                            ...
                            case 3:
                                if (FragmentManager.isLoggingEnabled(3)) {
                                    new StringBuilder("movefrom ACTIVITY_CREATED: ").append(this.mFragment);
                                }
    ...
    public void attach() {
        ...
        if (fragmentStateManager != null && (FragmentManager.USE_STATE_MANAGER || fragmentStateManager.getFragment().mState <= 0)) {
    ...
    public Fragment.SavedState saveInstanceState() {
        ...
        if (this.mFragment.mState < 0 || (saveBasicState = saveBasicState()) == null) {
            return null;
        }
