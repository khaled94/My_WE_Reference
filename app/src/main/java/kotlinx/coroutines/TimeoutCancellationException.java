...
public final class TimeoutCancellationException extends CancellationException implements dtv<TimeoutCancellationException> {
    public final dvi a;

    private TimeoutCancellationException(String str, dvi dviVar) {
        super(str);
        this.a = dviVar;
    }
