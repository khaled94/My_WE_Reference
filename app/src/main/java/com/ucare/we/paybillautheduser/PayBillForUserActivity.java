...
public class PayBillForUserActivity extends czy {
    @Inject
    djb a;
    @Inject
    djw b;
    ...
    public static /* synthetic */ void lambda$k12PCzqLxFaTig0e6sNuGwIaisw(PayBillForUserActivity payBillForUserActivity, View view) {
        payBillForUserActivity.a(view);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.imgBackButton.setOnClickListener(new View.OnClickListener() { // from class: com.ucare.we.paybillautheduser.-$$Lambda$PayBillForUserActivity$k12PCzqLxFaTig0e6sNuGwIaisw
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PayBillForUserActivity.lambda$k12PCzqLxFaTig0e6sNuGwIaisw(PayBillForUserActivity.this, view);
            }
        });
        ...
        try {
            ...
            this.webView.setWebViewClient(new WebViewClient() { // from class: com.ucare.we.paybillautheduser.PayBillForUserActivity.1
                {
                    PayBillForUserActivity.this = this;
                }

                @Override // android.webkit.WebViewClient
                public final void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
                    PayBillForUserActivity.this.a(sslErrorHandler, sslError);
                }

                @Override // android.webkit.WebViewClient
                public final void onPageFinished(WebView webView, String str) {
                    super.onPageFinished(webView, str);
                    PayBillForUserActivity.this.progressBar.setVisibility(8);
                }

                @Override // android.webkit.WebViewClient
                public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                    super.onPageStarted(webView, str, bitmap);
                    PayBillForUserActivity.this.progressBar.setVisibility(0);
                }
            ...
            if (this.b.k().equalsIgnoreCase("en")) {
                this.webView.loadUrl(this.c.f.getPay_landline_billEn());
            } else {
                this.webView.loadUrl(this.c.f.getPay_landline_billAr());
            }
    ...
    private void a(Exception exc) {
        ...
        super.runOnUiThread(new Runnable() { // from class: com.ucare.we.paybillautheduser.PayBillForUserActivity.2
            {
                PayBillForUserActivity.this = this;
            }
