...
public class SubscribeToMoreBundleActivity extends czy {
    TextView a;
    View.OnClickListener b = new View.OnClickListener() { // from class: com.ucare.we.morebundle.SubscribeToMoreBundleActivity.1
    ...
    public void onCreate(Bundle bundle) {
        ...
        dbi dbiVar = new dbi();
        dbiVar.setArguments(bundle2);
        beginTransaction.replace(R.id.lnrLayoutContainer, dbiVar).commit();
    }
}
