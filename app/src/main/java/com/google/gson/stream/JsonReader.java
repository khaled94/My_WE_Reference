...
public class JsonReader implements Closeable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x0093, code lost:
        if (isLiteral(r14) == false) goto L51;
     */
    ...
    */
    ...
    static {
        cqo.INSTANCE = new cqo() { // from class: com.google.gson.stream.JsonReader.1
            @Override // defpackage.cqo
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof cqu) {
                    cqu cquVar = (cqu) jsonReader;
                    cquVar.a(JsonToken.NAME);
                    Map.Entry entry = (Map.Entry) ((Iterator) cquVar.a()).next();
                    cquVar.a(entry.getValue());
                    cquVar.a(new cpy((String) entry.getKey()));
                    return;
                }
